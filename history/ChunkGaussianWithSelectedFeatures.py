...
import utils
#%%
class ChunkGaussianWithSelectedFeatures:
    def __init__(self, kf_k, seed, selected_feature_ids,**kwargs):
    ...
    def fit(self, tr_chunk, ts_chunk):
        ...
        test_X_imputed = self.imputer.transform(test_X[self.selected_feature_ids])
        #%
        '''
         3. normalization
        '''
